...
const AboutUsPage = () => {
  ...
  const staffData = (
    Array.isArray(i18nStaff) && i18nStaff.length ? i18nStaff : defaultStaffData
        ...
        <div className="container mx-auto px-4">
          <main className="flex flex-col items-center gap-y-24 md:gap-y-26 pb-8 md:pb-18">
            ...
            <section className="w-full max-w-6xl font-poppins">
              <h2 className="font-unbounded text-2xl sm:text-3xl font-bold text-center mb-14">
                {t('about.staff')}
              </h2>
                    ...
                    <AnimatedElement key={member.name}>
                      ...
                      >
                        <div className="flex items-center gap-5 mb-5">
                          <img
                            src={
                              staffImages[(member.avatar || member.name).toLowerCase()] ||
                              avatarPlaceholder
                            }
